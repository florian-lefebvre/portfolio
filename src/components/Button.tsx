...
const Button: ButtonComponent = forwardRef(
    <C extends React.ElementType = 'button'>(
        ...
        const baseClass =
            'inline-block translate-x-2 -translate-y-2 px-6 py-2 text-sm font-medium shadow-square shadow-neutral-12 transition-all hover:translate-x-0 hover:translate-y-0 hover:shadow-none focus:translate-x-0 focus:translate-y-0 focus:shadow-none focus:outline-none focus:ring-[3px] sm:text-base disabled:cursor-not-allowed disabled:opacity-75'
        const colorClass = {
            primary:
