---
title: 'Régiolangues: a collaborative resource portal'
description:
...
Régiolangues is a collaborative portal for French regional languages related
resources.
...
And I need client-side logic for iconify to run (it fetches icon client-side to
...
-   **Using the right tool for the right job**: This is actually the 2nd version
    of RégioLangues. First one was built like a recursive file explorer view
