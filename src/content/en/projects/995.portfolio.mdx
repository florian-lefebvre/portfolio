...
I had learned a lot of things since August 2020, so I decided to go with
...
choice. The space I was loosing for only a few infos was too much. I used the
official Nuxt modules such as [`@nuxt/content`](https://content.nuxtjs.org/) but
I struggled with the layout on some specific screen widths with weird horizontal
overflow, caused by code blocks.
...
thinking involved so that it can stay great for a long time.
