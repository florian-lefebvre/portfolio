...
including frontend and backend development, design (including design systems and
...
goal of yNotes was to provide an unofficial client for popular school management
systems (_ENTs_) and it was popular among students. Even though the project is
no longer maintained, it reached almost 7,000 downloads on Android in December
2022, which represents a **250% increase over two months**. This goes to show
that yNotes (and now op-ent) are addressing a real issue: current ENTs are not
very good.
...
is yet another React UI library but I think it can solve a problem: mixing
full-featured libraries like and headless components like . Have a look at the
...
[Mantine](<[inspired](https://mantine.dev/theming/colors/#add-custom-colors-types)>):
